...
contract ERC20BalanceChangeSafeEnforcerTest is CaveatEnforcerBaseTest {
    ////////////////////////////// State //////////////////////////////
    ERC20BalanceChangeSafeEnforcer public enforcer;
    ...
    function setUp() public override {
        ...
        enforcer = new ERC20BalanceChangeSafeEnforcer();
        vm.label(address(enforcer), "ERC20 Balance Change Safe Enforcer");
    ...
    function test_allow_ifBalanceDoesNotDecreaseTooMuch() public {
        ...
        // Terms: flag=true (decrease expected), token, recipient, allowed maximum decrease amount = 10.
    ...
    // Validates Safe enforcer behavior when starting balance is smaller than max decrease.
    // Example: cached=5, maxDecrease=10. Decreasing to 0 should PASS without underflow panics.
    function test_allow_ifStartingBalanceLessThanMaxDecrease() public {
        uint256 initialBalance_ = 5;
        vm.prank(delegator);
        token.mint(recipient, initialBalance_);
